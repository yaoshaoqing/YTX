...
public class CncampFragment extends BaseFragment implements AdapterView.OnItemClickListener,View.OnClickListener{
    protected View view;
...
//                    }
    ...
    private void showPopwindow() {
        ...
        // 在底部显示
        window.showAtLocation(CncampFragment.this.view.findViewById(R.id.start),
                Gravity.BOTTOM, 0, 0);
        //确定监听事件
...
//        this.international.setBackgroundResource(R.drawable.search_text_border);//国际综合
    ...
    public void click(){
        //循环设置监听事件事件
        CncampFragment.Click click = new CncampFragment.Click();
        LinearLayout select_theme_layout_1 = search_layout.findViewById(R.id.select_theme_layout_1);
        int layout_1 = select_theme_layout_1.getChildCount();
        for(int i=0;i<layout_1;i++){
            View v = select_theme_layout_1.getChildAt(i);
